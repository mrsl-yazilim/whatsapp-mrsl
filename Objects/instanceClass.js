...
class WhatsAppInstance {
    ...
    async verifyId(id) {
        ...
        throw new ErrorHandler(404, 'Numara WhatsApp\'ta kayıtlı değil');
    }
    ...
    async sendMediaURL(
        ...
        switch (type) {
            ...
            case "video":
                ...
                break;
            default:
                return { error: true, msg: "msgtype video veya resim olmalıdır" }
        }
    ...
    async logout() {
        ...
        this.instance.userData = {};
        return { error: false, message: "çıkış başarılı" };
    }
    ...
    async getGroupFromId(groupId) {
        ...
        try {
            ...
            return { error: true, message: "istenen grup bulunamadı" }
        }
    }
    ...
    async addNewParticipant(data) {
        try {
            ...
            return { error: true, message: "katılımcı eklenemiyor, grupta yönetici olup olmadığınızı kontrol edin" }
        }
    }
    ...
    async makeAdmin(data) {
        try {
            ...
            return { error: true, message: "bazı katılımcıları terfi ettiremiyor, grupta yönetici olup olmadığınızı veya katılımcıların olup olmadığını kontrol edin" }
        }
    }
    ...
    async demoteAdmin(data) {
        try {
            ...
            return { error: true, message: "bazı katılımcıları indiremiyor, grupta yönetici olup olmadığınızı veya katılımcıların olup olmadığını kontrol edin" }
        }
    }
    ...
    async createNewGroup(data) {
        try {
            ...
            return { error: true, message: "grup oluşturulamıyor, tüm katılımcıların gruba ekleme özelliğinin etkin olup olmadığını kontrol edin" }
        }
    }
    ...
    async leaveGroup(groupId) {
        try {
            ...
            return { error: true, message: "gruptan ayrılamaz, grubun var olup olmadığını kontrol edin" }
        }
    }
    ...
    async getInviteCodeOfGroup(groupId) {
        try {
            ...
            return { error: true, message: "davet kodu alınamıyor, grubun var olup olmadığını kontrol edin" }
        }
    }
}
